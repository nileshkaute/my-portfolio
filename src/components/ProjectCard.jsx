...
const ProjectCard = ({ title, video, techs, description, link, reverse }) => {
  return (
    ...
    <div className={`flex flex-col ${reverse ? 'md:flex-row-reverse' : 'md:flex-row'} items-center justify-center gap-10 md:gap-12 mb-60 w-full max-w-[1200px] mx-auto px-6 min-h-[60vh] antialiased`}>
      ...
      <div className={`w-full md:w-[35%] flex flex-col ${reverse ? 'md:items-end md:text-right' : 'md:items-start md:text-left'} items-center text-center`}>
        ...
        <h3 className="text-4xl md:text-5xl lg:text-6xl font-anton uppercase tracking-tighter mb-6 leading-[0.9] text-white">
          {title}
        </h3>
