...
const Button = ({ label = "Click", to, onClick, className = "", icon }) => {
  ...
  const baseStyle = `relative rounded font-semibold overflow-hidden w-28 sm:w-32 md:w-36  lg:w-40 h-8 sm:h-9 md:h-10 text-xs sm:text-sm md:text-base flex items-center justify-center  text-mocha-900 transition-all duration-300`;
